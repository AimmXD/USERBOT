...
from AimX import START_TIME
from AimX import SUDO_USER
from AimX.helper.PyroHelpers import ReplyCheck
from AimX.modules.help import add_command_help
from AimX.modules.bot.inline import get_readable_time

alive_logo = ALIVE_PIC or "https://telegra.ph/file/0b520f40be4bbca3835e2.jpg"
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **𝐒ᴜᴘᴘᴏʀᴛ-𝐂ʜᴀᴛ**: [|| ˹ AɪᴍX Sᴜᴘᴘᴏʀᴛ ˼ ||](t.me/AimXsupport)\n"
        f"├• **𝐔ᴘᴅᴀᴛᴇs**: [𝗔𝗶𝗺𝗫](t.me/AimmXD)\n"
        f"└• **𝐌ᴀsᴛᴇʀ**: [𝗬𝗔𝗦𝗜𝗥](t.me/cpr_yasir)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://github.com/AimmXD/USERBOT\nFork & Give an ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://gitHub.com/AimmXD")
